...
//   // minimal React state (prevents heavy rerenders)
//   const [progress, setProgress] = useState(0);

//   const metricsRef = useRef({ scrollLen: 0, maxX: 0 });
//   const rafRef = useRef(0);
//   const lastPRef = useRef(-1);

//   // update UI without rerendering
...
//     const update = () => {
//       const { scrollLen, maxX } = metricsRef.current;
//       const rect = outer.getBoundingClientRect();

//       const start = 0;
//       const end = -scrollLen + window.innerHeight;
//       const t = (start - rect.top) / (start - end);
//       const p = Math.min(1, Math.max(0, t));

//       // GPU transform (no React rerender)
...
//       // update React state rarely (every ~2%)
...
//       metricsRef.current.maxX = maxX;
//       metricsRef.current.scrollLen = scrollLen;
...
//                     />
//                   </div>
//                   <span ref={pctRef} className="text-sm text-[#6b5940]">
