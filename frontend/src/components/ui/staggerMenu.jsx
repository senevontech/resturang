      ...
      >
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
            {/* <img
              src={logoUrl || '/src/assets/logo/logo.png'}
              alt="Logo"
          ...
          <button
            ref={toggleBtnRef}
            className="sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer text-[#b8a37b] font-medium leading-none overflow-visible pointer-events-auto"
...
.sm-scope[data-open] .staggered-menu-wrapper {
  pointer-events: auto;
}
