...
class ArcballControl {
  ...
  constructor(canvas, updateCallback) {
    ...
    this._onLeave = () => (this.isPointerDown = false);
    this._onMove = (e) => {
...
class InfiniteGridMenu {
  ...
  dispose() {
    ...
    // We keep it light: browser will GC GL resources; if you want deep cleanup, tell me.
  }
...
export default function InfiniteMenu({ items = [], scale = 1.0, onNavigate }) {
  ...
  const handleButtonClick = () => {
    ...
    if (typeof onNavigate === "function") onNavigate(activeItem.link);
